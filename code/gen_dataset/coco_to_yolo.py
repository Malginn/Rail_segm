...
@click.option(
    "--coco_dataset",
    default=r"C:\Users\ivano\Документы\GitHub\Rail_segm\code\dataset_generate\dataset_big_img",
    help="Папка с датасетом формата COCO 1.0 (можно выгрузить из CVAT). По умолчанию COCO_dataset",
    type=str,
)
@click.option(
    "--yolo_dataset",
    default=r"C:\Users\ivano\Документы\GitHub\Rail_segm\code\dataset_generate\YOLO_dataset_big443",
